...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F7F2] text-[#1A1A1A] flex flex-col md:flex-row antialiased font-sans h-screen overflow-hidden print:h-auto print:overflow-visible">
      ...
      <div className="flex-1 relative bg-[#DEDDCF] p-8 flex items-start justify-center overflow-auto print:absolute print:inset-0 print:p-0 print:bg-white print:overflow-visible print:block z-0 print:z-50">
